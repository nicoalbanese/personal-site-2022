...
const Music = () => {
  return (
    <Layout>
      <h1>Music</h1>
      <p>I used to dj and make music under the name Guac (long story 😂). I {"don't"} make music much anymore but am an avid listener.</p>
      <Image
      ...
      <div className="mt-4">
        <div className="relative mb-4">
          ...
          <div className="relative flex justify-center">
            <span className="bg-gray-50 dark:bg-gray-900 dark:text-gray-50 px-3 text-lg font-medium text-gray-900">
              Songs
            </span>
          </div>
        </div>
